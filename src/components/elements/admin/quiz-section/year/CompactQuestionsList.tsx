...
export const CompactQuestionsList = React.memo(({
  isLoading,
  error,
  isEmpty,
  isFilteredEmpty,
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: () => 100, // Smaller estimate for compact cards
    overscan: 5,
  })
    ...
    <Card className="bg-white shadow-lg border-0">
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <div
            ref={parentRef}
            className="h-[75vh] overflow-auto rounded-lg border border-slate-200 bg-slate-50/50 p-4"
...
CompactQuestionsList.displayName = "CompactQuestionsList" 