...
export const createUserEntranceQuizHistory = async (userQuestions: UserHistoryType) => {
    try {
        ...
        const res = await axios.post(`${url}/api/v1/entrance-quiz-service/create-user-entrance-quiz-history`, userQuestions,{
